...
//목표 페이지
function Goal_Screen() {
  //각 미션을 클릭 상태 저장
  const [missionClickState, setMissionClickState] = useState({});

  //클릭 -> 미션 완료 처리
  const mission_complete = USER_MISSION_id => {
          ...
          <View
            ...
            <View style={styles2.user_mission}>
              ...
              <Pressable
                ...
                // 클릭 상태에 따라 버튼 스타일을 변경
                style={[
                  styles2.mission_success_button,
                  missionClickState[user_item.USER_MISSION_id] &&
